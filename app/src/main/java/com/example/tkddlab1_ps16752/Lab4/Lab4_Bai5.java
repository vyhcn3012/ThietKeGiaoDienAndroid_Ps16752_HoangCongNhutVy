...
public class Lab4_Bai5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lab4_bai5);
        imgCaNhan = findViewById(R.id.ellipse_1);
        tv2 = findViewById(R.id.txtLs);
        ListView listView = (ListView) findViewById(R.id.listView);
        ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(Lab4_Bai5.this, android.R.layout.simple_list_item_1, monHoc);
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        if(item.getItemId() == R.id.nav_home){
            Intent intent = new Intent(Lab4_Bai5.this, MenuLab4.class);
